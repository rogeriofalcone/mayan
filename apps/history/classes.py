...
class Event(object):
    ...
    def __init__(self, namespace, name, label, summary=None, details=None, expressions=None):
        ...
        try:
            ...
            self.history_type_obj.label = self.label
            self.history_type_obj.summary = self.summary
            self.history_type_obj.details = self.details
            self.history_type_obj.expressions = self.expressions
