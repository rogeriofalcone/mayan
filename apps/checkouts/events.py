...
from history.classes import EventNamespace, Event
...
history_document_auto_check_in = Event(namespace=namespace, name='document_auto_checked_in', label=_(u'Document automatically checked in'),
