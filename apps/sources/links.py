...
source_transformation_list = Link(text=_(u'transformations'), view='source_transformation_list', args=['object.source_type', 'object.pk'], permissions=[PERMISSION_SOURCES_SETUP_EDIT])
...
setup_source_edit = Link(text=_(u'edit'), view='setup_source_edit', args=['object.source_type', 'object.pk'], icon=icon_setup_source_edit, permissions=[PERMISSION_SOURCES_SETUP_EDIT])
setup_source_delete = Link(text=_(u'delete'), view='setup_source_delete', args=['object.source_type', 'object.pk'], icon=icon_setup_source_delete, permissions=[PERMISSION_SOURCES_SETUP_DELETE])
