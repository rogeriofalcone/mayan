...
link_bootstrap_setup_export = Link(text=_(u'export'), view='bootstrap_setup_export', args='object.pk', permissions=[PERMISSION_BOOTSTRAP_EXPORT])
link_bootstrap_setup_import_from_file = Link(text=_(u'import from file'), view='bootstrap_setup_import_from_file', permissions=[PERMISSION_BOOTSTRAP_IMPORT])
link_bootstrap_setup_import_from_url = Link(text=_(u'import from URL'), view='bootstrap_setup_import_from_url', permissions=[PERMISSION_BOOTSTRAP_IMPORT])
link_bootstrap_setup_repository_sync = Link(text=_(u'sync with repository'), view='bootstrap_setup_repository_sync', permissions=[PERMISSION_BOOTSTRAP_REPOSITORY_SYNC])
