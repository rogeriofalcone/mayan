...
link_transformation_create = Link(text=_(u'add transformation'), view='transformation_create', args=[get_app_label, get_module_name, 'resolved_object.pk'], permissions=[PERMISSION_TRANSFORMATION_CREATE], icon=icon_transformation_create)
