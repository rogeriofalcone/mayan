...
class IconSet(IconSetBase):
    ...
    dictionary = {
        ...
        DOCUMENT_BACKGROUND_ADD: ['document_background.png', 'add.png'],
        DOCUMENT_BACKGROUND_EDIT: ['document_background.png', 'pencil.png'],
        DOCUMENT_BACKGROUND_DELETE: ['document_background.png', 'delete.png'],
        DOCUMENT_BACKGROUND: 'document_background.png',
        DOCUMENT_BACKGROUND_DRAW_ERASER: 'draw_eraser.png',
        ...
        STATISTICS_ARROW_RIGHT: ['statistics.png', 'arrow_right.png'],
        STATISTICS_LIGHTNING: ['statistics.png', 'lightning.png'],
        STORAGE: 'storage.png',
        TAB: 'tab.png',
        TAB_ADD: 'tab_add.png',
