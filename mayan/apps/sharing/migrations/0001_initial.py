...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FSDocumentRenameCount'
        db.create_table('sharing_fsdocumentrenamecount', (
        ...
        db.send_create_signal('sharing', ['FSDocumentRenameCount'])


    def backwards(self, orm):
        # Deleting model 'FSDocumentRenameCount'
        db.delete_table('sharing_fsdocumentrenamecount')
    ...
    models = {
        ...
        'sharing.fsdocumentrenamecount': {
            'Meta': {'object_name': 'FSDocumentRenameCount'},
