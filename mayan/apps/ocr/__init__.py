...
from .links import (submit_document, submit_document_multiple, re_queue_document,
    ...
    queue_document_list, ocr_tool_link)
...
Link.bind_links([Document], [submit_document])
...
Link.bind_links([DocumentQueue], [document_queue_disable, document_queue_enable])

register_multi_item_links(['queue_document_list'], [re_queue_multiple_document, queue_document_multiple_delete])

Link.bind_links(['document_queue_disable', 'document_queue_enable', 'queue_document_list'], [queue_document_list], menu_name='secondary_menu')
