...
from .links import (document_signature_upload, document_signature_download,
    document_verify, document_signature_delete)
...
Link.bind_links(['document_verify', 'document_signature_upload', 'document_signature_download'], [document_signature_upload, document_signature_download, document_signature_delete], menu_name='sidebar')
