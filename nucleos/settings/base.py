"""
Django settings for nucleos EDMS project.
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'nucleos', 'media')
...
sys.path.append(os.path.join(BASE_DIR, 'nucleos', 'apps'))

STATIC_ROOT = os.path.join(BASE_DIR, 'nucleos', 'media', 'static')
