...
from nucleos import __version__ as nucleos_version
...
class Installation(SingletonModel):
    ...
    def nucleos_properties(self):
        namespace = PropertyNamespace('nucleos', _(u'nucleos EDMS'))

        namespace.add_property('uuid', _(u'UUID'), self.uuid, report=True)
        namespace.add_property('nucleos_version', _(u'nucleos EDMS version'), nucleos_version, report=True)
