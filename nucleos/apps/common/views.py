...
class nucleosPermissionCheckMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(nucleosPermissionCheckMixin, self).dispatch(request, *args, **kwargs)


class nucleosViewMixin(object):
    # TODO: split into two mixins, nucleosView and ExtraContextMixin
    extra_context = {}
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(nucleosViewMixin, self).dispatch(request, *args, **kwargs)

    def get_context_data(self, **kwargs):
        context = super(nucleosViewMixin, self).get_context_data(**kwargs)
        context.update(
            {
                'next': self.next_url,
...
class SingleObjectEditView(nucleosPermissionCheckMixin, nucleosViewMixin, UpdateView):
...
class SingleObjectCreateView(nucleosPermissionCheckMixin, nucleosViewMixin, CreateView):
    template_name = 'generic_form.html'
...
class SingleObjectDeleteView(nucleosPermissionCheckMixin, nucleosViewMixin, DeleteView):
...
class SingleObjectListView(nucleosPermissionCheckMixin, nucleosViewMixin, ListView):
