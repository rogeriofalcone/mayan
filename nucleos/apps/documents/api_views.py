...
class APIDocumentListView(generics.ListCreateAPIView):
    ...
    nucleos_object_permissions = {'GET': [PERMISSION_DOCUMENT_VIEW]}
    nucleos_view_permissions = {'POST': [PERMISSION_DOCUMENT_CREATE]}
...
class APIDocumentVersionCreateView(generics.CreateAPIView):
    ...
    permission_classes = (nucleosPermission,)
    nucleos_view_permissions = {'POST': [PERMISSION_DOCUMENT_NEW_VERSION]}
...
class APIDocumentVersionView(generics.RetrieveAPIView):
    ...
    permission_classes = (nucleosPermission,)
    nucleos_object_permissions = {'GET': [PERMISSION_DOCUMENT_VIEW]}
    nucleos_permission_attribute_check = 'document'
