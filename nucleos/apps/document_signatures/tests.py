...
TEST_SIGNATURE_FILE_PATH = os.path.join(settings.BASE_DIR, 'contrib', 'sample_documents', 'nucleos_11_1.pdf.sig')
...
class DocumentTestCase(TestCase):
    ...
    def test_new_document_version_signed(self):
        with open(TEST_SIGNED_DOCUMENT_PATH) as file_object:
            ...
            self.document.new_version(file=File(file_object, name='nucleos_11_1.pdf.gpg'), **new_version_data)
